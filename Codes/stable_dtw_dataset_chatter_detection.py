# -*- coding: utf-8 -*-
"""Stable_DTW_dataset_chatter_detection.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1p0zeRiKlrfcCdZsZm83EoWHr-10ZM86u
...
dtw_2p0_0_1 = dtw_matrix_generator_func(train_df_2p0_list, 0, 0, 5)
with open("stable_data_0_1.txt","w") as f:
  for ele in dtw_2p0_0_1:
    f.write("%s\n" %ele)

dtw_2p0_0_2 = dtw_matrix_generator_func(train_df_2p0_list, 0, 5, 11)
with open("stable_data_0_2.txt","w") as f:
  for ele in dtw_2p0_0_2:
    f.write("%s\n" %ele)